...
func registerAdminRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/admin/api/opencode/models/toggle", adminAuth(handleZenModelsToggle))
	...
	mux.HandleFunc("/admin/api/zen/models/toggle", adminAuth(handleZenModelsToggle))
