...
func registerAdminRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/admin/api/combos", adminAuth(handleCombosList))
	mux.HandleFunc("/admin/api/combos/save", adminAuth(handleCombosSave))
	mux.HandleFunc("/admin/api/combos/delete", adminAuth(handleCombosDelete))
